...
public class SlidingMenu extends HorizontalScrollView {
    ...
    private static final int MSG_FOR_OPEN_CHANGED = 200;
...
//                }
    ...
    public void openMenu() {
        ...
        this.smoothScrollTo(0, 0);
        isOpen = true;
        mOnOpenStateChangeListener.isOpening(true);
    }
    ...
    public void closeMenu() {
        ...
        this.smoothScrollTo(mMenuWidth, 0);
        isOpen = false;
        mOnOpenStateChangeListener.isOpening(false);
    }
...
//        ViewHelper.setScaleY(mContent, rightScale);
    ...
    public interface onOpenStateChangeListener {
        void isOpening(boolean flag);
    }

    onOpenStateChangeListener mOnOpenStateChangeListener = null;

    public void setOnOpenStateChangeListener(onOpenStateChangeListener e) {
//        this.run();
        mOnOpenStateChangeListener = e;
    }
...
//            message.what = MSG_FOR_OPEN_CHANGED;
//            message.arg1 = isOpen ? 1 : 0;
//            handler.sendMessage(message);
//        }
//    };
//
//    public void run(){
//        timer.schedule(timerTask, 500, 500);//每五秒执行一次handler
//        Log.d(TAG, "run: timer");
//    }
...
//            switch (msg.what) {
//                case MSG_FOR_OPEN_CHANGED: {
//                    mOnOpenStateChangeListener.isOpening(msg.arg1);
//                    break;
//                }
//            }
//        }
